...
type Config struct {
	...
	ElasticEndpoint      string `validate:"omitempty,url|eq_ignore_case=off" help:"the URL of your ElasticSearch instance, or off to search contacts and messages in Postgres"`
	...
	EmbeddingsEndpoint string `validate:"omitempty,http_url|eq_ignore_case=off" help:"the base URL of an OpenAI compatible embeddings service, or off to disable knowledge base embeddings"`
